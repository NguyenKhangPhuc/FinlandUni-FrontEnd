        ...
        <div className="w-full flex flex-col items-center text-white mt-10">
            ...
            <section className="w-2/3 text-white bg-gray-800 p-10 rounded-lg">
                ...
                <ul>
                    ...
                    <li>In general, the cost of a room in a shared student apartment ranges between €200 and €380 per month, depending on the city and housing type. Studios and family apartments are more private but typically come with higher rent and longer wait times.</li>
