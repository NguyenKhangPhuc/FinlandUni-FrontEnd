...
import fb from '../src/app/assets/fb_logo.webp'
import linkedIn from '../src/app/assets/linkedIn.webp'
import ins from '../src/app/assets/ins_logo.png'
import Link from 'next/link'
const Footer = () => {
    ///This component contain the footer of the website
    return (
        <div className="w-full flex flex-col items-center border-t border-gray-800 text-white mt-15 text-center">
            <div className='sm:flex-row lg:w-5/6 w-full flex  flex-col  border-b border-gray-800 rounded-lg p-5 gap-5'>
                ...
                <div className='sm:p-5 flex-1 flex flex-col p-2 items-center border-r border-gray-800'>
                    ...
                    <Link href={`https://www.facebook.com/`} className='flex items-center underline text-blue-500 lg:text-lg text-sm'><Image src={fb} width={30} alt='fb' />Facebook</Link>
                    <Link href={`https://www.instagram.com/khang_phucs/`} className='flex items-center underline text-blue-500 lg:text-lg text-sm'>
                        <Image src={ins} width={30} alt='fb' />Instagram
                    </Link>
                    <Link href={`https://www.linkedin.com/in/khang-phuc-nguyen-a04809325/`} className='flex items-center underline text-blue-500 lg:text-lg text-sm'>
                        <Image src={linkedIn} width={30} alt='fb' />LinkedIn
                    </Link>
                </div>
            </div>
